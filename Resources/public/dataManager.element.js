(function ($) {
    ...
    $.widget("mapbender.mbDataManager", {
        ...
        _create: function () {
            ...
            widget.TYPE = "Data Maanger";

            widget.id = element.attr("id");

            if (!Mapbender.checkTarget("mbDataManager", widget.options.target)) {
                return;
            }
            ...
            var qe = new Mapbender.DataManager.QueryEngine(widget);
            ...
            Mapbender.elementRegistry.waitCreated('.mb-element-printclient').then(function (printClient) {
                ...
                $.extend(widget.printClient, Mapbender.DataManager.printPlugin);
            });
        },
        ...
        setup: function () {
            ...
            var createSchemes = function () {
                ...
                _.each(rawSchemes, function (rawScheme, schemaName) {
                    ...
                    widget.schemes[schemaName] = new Mapbender.DataManager.Scheme(rawScheme, widget, index++);
                ...
                // if (usesAllScheme()) {
                //     widget.schemes['all'] = new Mapbender.DataManager.AllScheme({
                //         label: Mapbender.DataManagerTranslator.translate('schema.allgeometries'),
                //         schemaName: 'all'
                //     }, widget, index++);
